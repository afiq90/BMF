...
class SHCircleBarController: UITabBarController {
    ...
    open override func viewDidLoad() {
        ...
        //Add new view to tabbar, so that we can change the background color
        let bgView = UIView(frame: CGRect(x: 0.0, y: 0.0, width: self.view.bounds.size.width, height: _barHeight))
    ...
    private var _barHeight: CGFloat = 50
